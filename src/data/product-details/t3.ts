...
export const T3_PRODUCT_DETAIL: ProductDetailPageData = {
  ...
  hero: {
    ...
    supportingCopy: [
      ...
      'คลาสนี้เริ่มจาก Report chaos แล้วจัด Stage, Field, Owner และ Next action ให้คนกรอกกับคนใช้ข้อมูลเข้าใจตรงกัน ก่อนทดลองประชุมจากดีลตัวอย่างที่ปิดข้อมูลแล้ว',
    ],
  ...
  decisionCtas: [
    ...
    },
    {
      ...
      body: 'โหลด Class Outline ฉบับ PDF ไปเปิดกับทีมได้เลยครับ มีครบทั้งหัวข้อที่เรียนตลอดวัน สิ่งที่ทีมลงมือทำในห้อง และของที่ถือกลับไป',
      variant: 'light',
      actions: [
        { kind: 'download', label: 'ดาวน์โหลด Class Outline (PDF)', intent: 'course_outline', available: true, href: '/services/outlines/t3-sales-back-office.pdf' },
  ...
  investment: {
    included: [
      ...
      'ใบเสนอราคา ใบแจ้งหนี้ และใบเสร็จรับเงินในนามบริษัท (ราคานี้ไม่มี VAT · บริษัทหัก ณ ที่จ่าย 3% ได้ และส่ง 50 ทวิ กลับมา)',
    ],
  ...
  faq: [
    { question: 'คลาสนี้ต่างจาก I1 แบบสร้างระบบให้ยังไง?', answer: 'T3 จบที่ความรู้ Operating rule, Template และ Dashboard prototype ที่ทีมคุณทำต่อได้ครับ I1 เพิ่มขั้น Data map, Build, UAT, User training, Handover และการดูแลระบบตาม Scope เหมาะเมื่อบริษัทไม่มีคนทำต่อหรืออยากให้ผมรับผิดชอบการส่งมอบ' },
    ...
    { question: 'AI ช่วยตรงไหนในคลาส?', answer: 'AI ช่วยจัดรูปแบบข้อมูล ตรวจ Field ที่ขาด สรุปประเด็น และร่างรายการ Follow-up จากกติกาที่ทีมกำหนดครับ งานที่มีผลต่อการประเมินคน การอนุมัติส่วนลด หรือการติดต่อถึงลูกค้าต้องมีคนตรวจ' },
    ...
    { question: 'มี Certificate หรือไฟล์ทบทวนมั้ย?', answer: 'มีครับ Certificate of Completion อยู่ใน Bonus หลังคลาส (ชิ้นที่ 07) ออกให้ผู้เรียนที่ส่ง Report ตามมาตรฐานใหม่ 2 รอบ และ Weekly Review 1 รอบที่จบด้วย Owner, Next action และ Due ส่วนไฟล์ทบทวนและการดูแลหลังเรียนเป็นไปตาม Scope ในใบเสนอราคาครับ' },
  ],
  cta: {
  ...
  seo: {
    title: 'คลาสอบรมวางระบบหลังบ้านฝ่ายขาย: Report + Dashboard + AI',
