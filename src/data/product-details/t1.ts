...
export const T1_PRODUCT_DETAIL: ProductDetailPageData = {
  ...
  hero: {
    ...
    supportingCopy: [
      ...
      'คลาสนี้เริ่มจากจิตวิทยาการตัดสินใจของลูกค้า ฝึกถาม ฟัง และต่อรองบนคุณค่า แล้วค่อยสร้าง AI Sales Coach จากข้อมูลบริษัท เพื่อช่วยเตรียม ซ้อม และทบทวนดีลจริง โดยเซลล์ยังเป็นคนตัดสินใจทุกครั้ง',
    ],
  ...
  decisionCtas: [
    ...
    },
    {
      ...
      variant: 'light',
      actions: [
        { kind: 'download', label: 'ดาวน์โหลด Class Outline (PDF)', intent: 'course_outline', available: true, href: '/services/outlines/t1-sales-psychology-ai-agent.pdf' },
  ...
  boundary: {
    ...
    body: [
      ...
      'AI Agent ในคลาสนี้เป็นผู้ช่วยฝึกและเตรียมงานภายใต้ Human Review ครับ ส่วนการคุยกับลูกค้า การตัดสินใจ ราคา และเงื่อนไขยังอยู่กับเซลล์ งาน CRM หรือ Dashboard production แยกเป็นบริการ Implementation',
    ],
  },
  reasons: [
  ...
  investment: {
    included: ['In-house Training ตลอดวันอบรม', 'ปรับ Workshop ให้เข้ากับสินค้า ลูกค้า และข้อโต้แย้งของบริษัท', 'Template และ Take-home ตามรายการ', 'ไฟล์ทบทวน/การดูแลหลังเรียนตามขอบเขตที่ตกลงก่อนวันอบรม', 'ใบเสนอราคา ใบแจ้งหนี้ และใบเสร็จรับเงินในนามบริษัท (ราคานี้ไม่มี VAT · บริษัทหัก ณ ที่จ่าย 3% ได้ และส่ง 50 ทวิ กลับมา)'],
  ...
  faq: [
    { question: 'คลาสนี้ต่างจาก T2 แบบ 2 วันยังไง?', answer: 'T1 เริ่มเมื่อทีมมี Lead หรือมีลูกค้าให้คุยแล้ว เน้นเหตุผลซื้อ คำถาม การต่อรอง Role-play และ Follow-up ส่วน T2 เริ่มก่อนหน้านั้น ครอบคลุมการสร้าง Demand จาก Content + Ads การรับ Lead และการส่งต่อจาก Marketing ไป Sales' },
    { question: 'จิตวิทยาการขายในคลาสหมายถึงการอ่านใจหรือควบคุมลูกค้าหรือเปล่า?', answer: 'เปล่าครับ เราใช้หลักจิตวิทยาเพื่อเข้าใจว่าลูกค้ากำลังพยายามทำอะไร กังวลอะไร และใช้เกณฑ์อะไรตัดสินใจ เป้าหมายคือถามและให้ข้อมูลได้ตรงขึ้น โดยเคารพสิทธิ์ตัดสินใจของลูกค้า' },
  ...
  cta: {
    ...
    finalMicrocopy: 'คุยเพื่อเช็กโจทย์ก่อนครับ ถ้าปัญหาไม่ตรงกับคลาสนี้ ผมจะบอกตามตรง',
  ...
  seo: {
    title: 'คลาสจิตวิทยาการขาย + AI Agent สำหรับทีมขาย B2B',
