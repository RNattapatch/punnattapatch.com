...
import t2System06 from '../../assets/services/proof/t2-system-06.png';
...
const SYSTEM_SECTION: ProductSystemSection = {
  ...
  opener: {
    ...
    shot: {
      ...
      label: 'รุ่นสาธิต · ข้อมูลสมมติทั้งหมด',
    ...
    items: [
      {
        ...
        shot: {
          ...
          label: 'ภาพรุ่นสาธิต ใช้ข้อมูลบริษัทสมมติ',
  ...
  goldenPath: {
    ...
    shot: {
      ...
      label: 'ภาพจากรุ่นสาธิต ใช้ข้อมูลบริษัทสมมติทั้งหมด',
  ...
  handoff: {
    ...
    shot: {
      image: t2System06,
      alt: 'หน้าจอรุ่นสาธิตแสดงด่าน 0 ถึงด่าน 5 พร้อมสถานะการส่งมอบและข้อมูลบริษัทสมมติ',
      label: 'ภาพรุ่นสาธิต ใช้ข้อมูลสมมติ',
      caption: 'ภาพนี้แสดงลำดับ 6 ด่านก่อนติดตั้ง ระหว่างเรียน และหลังคลาส 30 วัน',
      delta: BASE_DELTA,
    },
  },
  metrics: {
    ...
    // ⚠️ ตัวเลขจริงยังไม่มี — คุณปันเติมก่อนเปิด flag เท่านั้น ห้ามเดา (packet STOP RULE 8)
    items: [
      { label: 'งานที่ระบบผลิตต่อสัปดาห์', value: '{{PUN_METRIC_WEEKLY_OUTPUT}}', note: 'นับงานที่ Content Center · News Desk · Intel Warroom ผลิตให้ผมนำไปใช้จริง' },
      { label: 'ค่าใช้ AI ต่อเดือน', value: '{{PUN_METRIC_MONTHLY_COST}}', note: 'เป็นค่าใช้ AI ในบัญชีของผมเอง และไม่ได้รวมอยู่ในค่าอบรม' },
      { label: 'เวลาที่ผมไม่ต้องลงมือเองต่อสัปดาห์', value: '{{PUN_METRIC_HOURS_SAVED}}', note: 'นับเฉพาะงานซ้ำที่ระบบรับไปทำ โดยผมยังเป็นคนตรวจและตัดสินใจ' },
    ],
