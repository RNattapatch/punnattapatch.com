...
import t2System01 from '../../assets/services/proof/t2-system-01.png';
import t2System02 from '../../assets/services/proof/t2-system-02.png';
import t2System03 from '../../assets/services/proof/t2-system-03.png';
import t2System04 from '../../assets/services/proof/t2-system-04.png';
import t2System05 from '../../assets/services/proof/t2-system-05.png';
...
const BASE_DELTA = [
  { inShot: 'ข้อมูลบริษัทสมมติที่มากับตัวอย่าง', youGet: 'ข้อมูลบริษัทของคุณจากแบบฟอร์มก่อนเรียน' },
  { inShot: `ชื่อระบบขึ้นว่า ${N}`, youGet: 'ชื่อจริงที่เคาะก่อนวันส่งมอบ' },
  { inShot: 'โต๊ะที่เปิดใช้ 3 โต๊ะ', youGet: 'สามโต๊ะเท่ากัน โต๊ะเพิ่มอยู่ในรุ่นดูแลรายเดือน' },
];
...
const SYSTEM_SECTION: ProductSystemSection = {
  ...
  opener: {
    ...
    shot: {
      image: t2System01,
      alt: `ภาพหน้าจอรุ่นสาธิตของ ${N} แสดงทางเข้าโต๊ะ Campaign, Lead และ Review พร้อมข้อมูลสมมติ`,
      label: 'ภาพจากระบบจริง · ข้อมูลในภาพเป็นบริษัทสมมติ',
      caption: `หน้าแรกของ ${N} เปิดมาแล้วเห็นโต๊ะ Campaign, Lead และ Review ก่อนเริ่มงาน`,
      delta: [...BASE_DELTA, { inShot: 'ปุ่มและหน้าจอที่เห็นทั้งหมด', youGet: 'เท่ากัน ระบบไม่มีปุ่มที่กดแล้วไม่เกิดอะไร' }],
    },
  },
  failure: {
    ...
    items: [
      {
        ...
        shot: {
          image: t2System02,
          alt: 'ตารางบรีฟมีแกนเรื่อง Hook คนที่พูดถึง CTA คนตรวจ และสถานะของแต่ละชิ้น',
          label: 'ภาพจากระบบจริง · ข้อมูลในภาพเป็นบริษัทสมมติ',
          caption: 'หน้าจอโต๊ะ Campaign แสดงรายการบรีฟและด่านตรวจก่อนเผยแพร่',
          delta: BASE_DELTA,
        },
      },
      {
        ...
        shot: {
          image: t2System03,
          alt: 'ตาราง Lead แสดงงบ คนตัดสินใจ ปัญหา กรอบเวลา คนดูแล สิ่งที่ต้องทำต่อ และวันครบกำหนด',
          label: 'ภาพจากระบบจริง · ข้อมูลในภาพเป็นบริษัทสมมติ',
          caption: 'หน้าจอโต๊ะ Lead แสดงเวลาตอบ การคัดกรอง คนดูแล และงานที่ต้องตามต่อ',
          delta: [...BASE_DELTA, { inShot: 'จำนวน Lead ตัวอย่างในภาพ', youGet: 'ข้อมูลสมมติสำหรับซ้อม ล้างกลับเป็นสถานะตั้งต้นได้' }],
        },
      },
      {
        number: '03',
        ...
        shot: {
          image: t2System04,
          alt: 'บันทึกหนึ่งหน้ามีคอนเทนต์กับ Lead และ 5 โซน: ข้อความ ตอบแรก คัด ส่งต่อ ตามต่อ',
          label: 'ภาพจากระบบจริง · ข้อมูลในภาพเป็นบริษัทสมมติ',
          caption: 'หน้าจอโต๊ะ Review แสดงผลคอนเทนต์ จุดที่งานหลุด และผู้รับผิดชอบรอบถัดไป',
          delta: BASE_DELTA,
        },
      },
    ],
  ...
  goldenPath: {
    ...
    shot: {
      image: t2System05,
      alt: 'ภาพหน้าจอรุ่นสาธิตแสดงงานที่ไหลจากโต๊ะ Campaign ไปยังโต๊ะ Lead และโต๊ะ Review',
      label: 'ผลตรวจจากระบบจริง · ข้อมูลในภาพเป็นบริษัทสมมติ',
      caption: 'ผลตรวจของระบบเองหลังเดินงาน 1 ชิ้นครบเส้น ตัวอย่างในภาพไม่มีชื่อจริง เบอร์จริง หรือตัวเลขดีลจริงของใคร',
      delta: BASE_DELTA,
    },
  },
  handoff: {
