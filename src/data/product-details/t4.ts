...
export const T4_PRODUCT_DETAIL: ProductDetailPageData = {
  ...
  bonusCards: {
    ...
    heading: 'Bonus 6 ชิ้น + Certificate ช่วยให้ทีมเริ่มและใช้ต่อได้ง่ายขึ้น',
    ...
    items: [
      ...
      { number: '02', title: '30 AI Workflow Ideas', user: 'Owner และ Manager', timing: 'ก่อนเลือกงานถัดไป', outcome: 'งานซ้ำ 30 แบบที่ AI ช่วยได้ (งานขาย 10 · หลังบ้าน 10 · ปฏิบัติการ 10) ใช้หา Agent ตัวถัดไปเองโดยไม่เริ่มจากชื่อ Tool', format: 'Google Sheet · ส่งหลังจบคลาส' },
      { number: '03', title: 'AI Build Brief: Prompt สั่ง AI สร้างระบบโดยไม่บวม', user: 'คนสร้างต้นแบบและ Process owner', timing: 'ก่อนเริ่ม Build ตัวที่ 2, 3', outcome: 'เขียน Goal, User, Input, Rule, Exception, Output และ Acceptance ให้ครบก่อนสั่ง AI', format: 'Google Doc · ส่งหลังจบคลาส' },
      { number: '04', title: 'AI Data Safety Checklist 30 จุด', user: 'Owner, Manager และ Core team', timing: 'ก่อนให้ AI แตะข้อมูล', outcome: 'ติ๊กเองว่าข้อมูลไหนใช้ได้ ต้อง Mask ต้องขออนุมัติ หรือห้ามส่งออก — ตรวจก่อนเปิด Agent ใหม่ทุกตัว', format: 'Google Sheet / PDF · ส่งหลังจบคลาส' },
      { number: '05', title: 'Check-in 30 นาที + ตรวจการบ้าน + กลุ่ม LINE ศิษย์เก่า', user: 'Owner, Manager และผู้เรียน', timing: 'ภายใน 30 วันหลังคลาส แล้วถามต่อได้ไม่จำกัดเวลา', outcome: 'ดูเคสที่ใช้จริง เวลาที่ลดได้ และจุดที่ติด', format: 'Google Meet 30 นาที + กลุ่ม LINE · ผมตอบเอง' },
      { number: '06', title: 'Workflow Example Library + คลังศิษย์เก่า', user: 'ทุกฝ่ายที่กำลังหา Use case', timing: 'ตอนเทียบแนวทางและหลังจบคลาส', outcome: 'ตัวอย่างงานที่ทำสำเร็จแล้วพร้อมหมายเหตุว่าตรงไหนไม่ควรลอกทั้งก้อน · เพิ่มเคสใหม่จากบริษัทอื่น (ปิดชื่อ) ทุกเดือน', format: 'Google Drive ศิษย์เก่า · อัปเดต 12 เดือน' },
      { number: '07', title: 'Certificate of Completion', user: 'ผู้เรียนที่ส่งการบ้านครบ', timing: 'หลังส่งการบ้านหลังคลาส', outcome: 'ใบรับรองที่แปลว่าทำจริง ไม่ใช่แค่นั่งฟัง — ออกให้เมื่อทีมส่งผล Prototype run ด้วยข้อมูลจำลอง และ Owner ลงนามใน Stop/Revise/Install Decision Memo', format: 'PDF · ออกให้เมื่อส่งการบ้านครบ' },
    ],
  },
  bonusValues: {
    ...
    items: [
      ...
      { number: '05', icon: '🎧', title: 'Check-in 30 นาที + ตรวจการบ้าน + กลุ่ม LINE ศิษย์เก่า', points: ['เจ้าของได้: มีคนกลับมาดูว่าทีมใช้จริงไหม ภายใน 30 วันหลังคลาส · ดูเคสที่ใช้จริง เวลาที่ลดได้ และจุดที่ติด', 'ทีมได้: กลุ่ม LINE ศิษย์เก่าตลอดชีพ ถามเรื่องการใช้ของจากคลาสได้ไม่จำกัดเวลา (ไม่รวมรับทำระบบ ผลิต Content หรือตัดสินใจแทน)', 'Google Meet 30 นาที + LINE · ผมตอบเอง ไม่ใช่แอดมิน'], value: 2200, basis: '30 นาที เวลาผมจริง' },
      { number: '06', icon: '📚', title: 'Workflow Example Library + คลังศิษย์เก่า', points: ['เจ้าของได้: ตัวอย่างงานที่ทำสำเร็จแล้วพร้อมหมายเหตุว่าตรงไหนไม่ควรลอกทั้งก้อน · เพิ่มเคสใหม่จากบริษัทอื่น (ปิดชื่อ) ทุกเดือน', 'ทีมได้: ดู Pattern แล้วปรับตามบริบทบริษัท ไม่ต้องเริ่มจากศูนย์', 'Google Drive ศิษย์เก่า · อัปเดต 12 เดือน'], value: 6500, basis: '1.5 ชม.' },
      { number: '07', icon: '🏆', title: 'Certificate of Completion', points: ['เจ้าของได้: หลักฐานว่าทีมทำการบ้านหลังคลาสจริง ไม่ใช่แค่นั่งฟัง', 'ทีมได้: ใบรับรองใส่โปรไฟล์ อ้างอิงกับหัวหน้าและลูกค้าได้', 'ออกให้เมื่อทีมส่งผล Prototype run ด้วยข้อมูลจำลอง และ Owner ลงนามใน Stop/Revise/Install Decision Memo'], value: 0, basis: 'ประเมินค่าไม่ได้', valueLabel: '∞' },
    ],
  ...
  whyMe: {
    ...
    items: [
      ...
      { icon: '🎁', title: 'Bonus 6 ชิ้น + Certificate + Support หลังคลาส', body: 'เครื่องมือใช้ต่อ 6 ชิ้น ({{bonusTotal}}) แถมฟรี นัดทบทวนกับผม 30 นาทีภายใน 30 วัน กลุ่ม LINE ศิษย์เก่า และใบรับรองเมื่อทีมส่งการบ้านครบ' },
    ],
  },
  instructorProfile: {
    eyebrow: 'Instructor',
