...
export const SERVICE_DETAILS: Record<string, ServiceDetail> = {
  'ai-workshop': {
    slug: 'ai-workshop',
    accent: 'cyan',
    eyebrow: 'AI Workshop · 1 วัน',
    headline: 'ทีมขายเสียเวลา',
    headlineAccent: '5+ ชั่วโมง/สัปดาห์',
    headlineTail: 'ผมปลดล็อกคืนให้ในวันเดียว',
    subhead:
      'AI Day Workshop 1 วันเต็ม — ทีมขาย 5-20 คน กลับไปพร้อม AI workflow ใช้งานได้ทันที ไม่ใช่ concept ไม่ใช่ slide ไม่ใช่ roadmap',
    pains: [
      {
        emoji: '📄',
        title: 'ทีมเสียเวลากับงานซ้ำทุกวัน',
        body: 'ทำ report ด้วยมือ copy-paste ข้อมูลลูกค้า พิมพ์ follow-up ทีละคน งานพวกนี้กินเวลาวันละ 1-2 ชม.',
      },
      {
        emoji: '😵',
        title: 'เคยซื้อ AI course แต่ใช้จริงไม่ได้',
        body: 'เห็นโปรโมชั่น "AI for Sales" เยอะมาก ซื้อมาแล้วดูจบก็ยังใช้ไม่ได้ เพราะไม่ match กับธุรกิจจริง',
      },
      {
        emoji: '🤔',
        title: 'ไม่รู้จะเริ่มจากตรงไหน',
        body: 'อ่านข่าว AI ทุกวัน แต่ยังไม่เห็นเป็นจริงกับธุรกิจตัวเอง ChatGPT ก็ถามไปเฉยๆ ไม่รู้จะ workflow ยังไง',
      },
    ],
    audience: [
    ...
    outcomes: [
      'กลับไปพร้อม AI workflow 1 ตัวที่ใช้งานได้จริงตั้งแต่วันรุ่งขึ้น',
      'วัดผล Before / After ภายใน workshop วันเดียว',
      'Team lead maintain ระบบเองได้ ไม่ต้องพึ่งผมต่อเดือน',
      'ทีมเห็นว่า AI ทำได้จริงกับธุรกิจตัวเอง ไม่ใช่แค่ theory',
    ],
    priceHeadline: '฿30,000 / 1 วัน',
    priceNote: 'ราคาเดียวจบ ไม่มีค่าใช้จ่ายแอบแฝง · 100% upfront · ไม่มีสัญญาผูกมัดระยะยาว',
    inclusions: [
      'Workshop 1 วัน (6-7 ชม.) On-site หรือ Online',
      'AI workflow 1 ตัว build จบในห้อง',
      'Documentation + screen recording',
      'Team lead training session',
      'Follow-up email 1 ครั้ง หลัง workshop 1 สัปดาห์',
    ],
    notIncluded: [
      'Follow-up 30 วัน (อยู่ใน AI Workshop + Follow-up package ฿50,000)',
      'Monthly retainer (คุยได้หลัง workshop)',
      'ค่าเดินทาง on-site ต่างจังหวัด (คิดแยก)',
    ],
    faqs: [
      {
        q: 'ทีมต้องเตรียมอะไรบ้างก่อน Workshop',
        a: 'ผมส่ง checklist ล่วงหน้า 1 สัปดาห์ — หลักๆ คือเตรียม Google account, access ไปยัง data ที่อยากใช้, และมีตัวอย่าง workflow จริง 2-3 เคสมาเล่าให้ฟัง',
      },
      {
        q: 'ถ้าทีมไม่เก่ง tech จะตามทันไหม',
        a: 'ตาม 100% ได้ ลูกค้าผม 8/10 ทีมไม่มีใครเขียน code — stack ที่ผมใช้ (Sheets + n8n) ออกแบบมาให้ non-tech ดูแลต่อเองได้',
      },
      {
        q: 'หลัง Workshop ถ้าเจอปัญหาถามใครได้',
        a: 'มี follow-up email ฟรี 1 ครั้ง หลัง workshop 1 สัปดาห์ ถ้าต้องการ support ต่อเนื่อง ต่อ AI Workshop + Follow-up package (฿50,000) ได้',
      },
    ],
  },
