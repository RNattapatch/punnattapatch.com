...
export const SERVICE_DETAILS: Record<string, ServiceDetail> = {
  'ai-workshop': {
    ...
    priceHeadline: '฿25,000 / 1 วัน',
    priceCompare: 'ราคาเต็ม ฿30,000 · Sale price ฿25,000 · Early Bird ฿19,900 (เงื่อนไข: สมัครก่อน batch ถัดไปเปิด)',
    priceNote: '100% upfront ก่อนเริ่มงาน · ไม่มีสัญญาผูกมัดระยะยาว · ไม่มีค่าใช้จ่ายแอบแฝง',
    inclusions: [
