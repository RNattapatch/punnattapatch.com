  ...
  'ai-workshop': {
    ...
    pains: [
      ...
      },
      {
        ...
        body: 'เคยจ่ายเงินส่งทีมไปเรียนคลาส AI แล้ว แต่กลับมาก็เห่อใช้กันอยู่ 3 วันแรกแล้วก็เลิก หรือที่แย่กว่านั้นคือคนที่ไปเรียนมาดันลาออก เอาความรู้ไปกับเขาด้วย ผมอยากได้ "ระบบ" ที่เป็นของบริษัท ไม่ใช่ "ทักษะ" ที่ติดอยู่กับตัวคน',
      },
    ],
    audience: [
      'SME B2B ทีมขาย 5-20 คน ที่เจ้าของอยากให้ทีมใช้ AI ลดงานซ้ำ',
      'ทีมที่เคยซื้อคลาสออนไลน์แล้วไม่ได้ implement ต่อ',
    ...
    whyMe: {
      ...
      marketGap: {
        intro: 'คลาส AI ในไทยตอนนี้มีเยอะมาก แต่พอดูดีๆ จะเห็นว่าส่วนใหญ่วิ่งไปทางเดียวกันหมด และยังไม่ใช่สิ่งที่ทีมขาย B2B ต้องการ',
        segments: [
          {
            name: 'คลาส AI ทั่วไป',
