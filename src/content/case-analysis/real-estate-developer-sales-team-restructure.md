---
title: "Real Estate Developer: ออกแบบ Commission ใหม่ให้ทีมขายโครงการบ้านจัดสรร หลังเซลล์เก่งลาออก 3 คนใน 6 เดือน"
...
outcome: "Top performer retention 100% for 12 months, Revenue per rep +45%, Turnover 35% → 0% in year 1"
anonymized: true
---
...
ซ่อน commission = ทีมเดาใจเจ้านาย + ขวัญเสีย

**3. Team bonus = กันความขัดแย้ง**
Tier-based คนเดียวอาจทำให้ top เก็งข้อมูลไม่แบ่งปัน
Team bonus = top performer ยอมช่วย junior เพราะมันช่วย bonus ตัวเอง

**4. Explain rationale ก่อนเปลี่ยน**
...
- **Investment:** วางระบบขายทั้งบริษัท ฿65,000 (โปรเจกต์ 1 เดือน) <!-- price:historical -->
