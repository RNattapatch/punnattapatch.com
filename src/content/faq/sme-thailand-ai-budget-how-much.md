...
answerSummary: "ปีแรกลงทุน ฿100,000-150,000 แบ่ง: Audit/workshop ฿20-30k, Build wedge แรก ฿50-65k, Tool subscription ฿1,500-10,000/เดือน ถ้าเลือก wedge ถูก ROI คืนใน 2-4 เดือน ปีสอง scale ได้ด้วยตัวเองไม่ต้องจ่ายที่ปรึกษาอีก"
lang: th
...
SME ไทยที่มีรายได้ 30-200 ล้านบาท ควรตั้งงบ AI Transformation ปีแรกไว้ที่ 100,000-150,000 บาท และสามารถคืนทุนได้ใน 2-4 เดือนหากเลือก wedge แรกได้ถูกต้อง

## Breakdown งบประมาณปีแรก

| Stage | ช่วงราคา | ระยะเวลา |
|---|---|---|
| Audit + roadmap (workshop 1 วัน) | ฿20,000-30,000 | 1-2 สัปดาห์ |
...
- ถ้า pipeline คือ ฿5M/เดือน และ cycle time ลดลง 2 วัน จะทำให้ pipeline velocity เพิ่มขึ้น 15%
- เพิ่มรายได้ประมาณ ฿750,000/เดือน ทำให้คืนทุน ROI ภายในเดือนแรก

**3. Lead qualification AI → ลดเวลาที่เซลส์เสียไปกับ lead คุณภาพต่ำ**
...
**Option A: Scale ต่อเอง (฿20,000/ปี)**
