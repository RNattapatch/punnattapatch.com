...
ถ้าไม่ใช่ 3 ข้อนี้ — เพิ่ม 1 คน = เพิ่ม cost ประมาณ ฿480,000-฿960,000/ปี (เงินเดือน + commission + overhead) แต่ revenue ไม่ได้ขึ้นตาม
...
| Revenue per rep | revenue 12 เดือน ÷ จำนวน rep | ถ้าตกลงเรื่อยๆ = ปัญหา productivity ไม่ใช่ปัญหาคนไม่พอ |
...
Client รายนึงลด response time จาก 45 นาที → 12 นาทีด้วยแค่การสร้าง template 8 แบบ + assign rotation ใน Line OA — ไม่จ้างเพิ่มเลย conversion rate ขึ้น 7%
...
- Conversion rate ต่ำกว่า 12% — ปัญหาที่ skill ไม่ใช่ capacity
