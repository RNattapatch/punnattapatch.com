...
location:
  name: "Co-working Premium Bangkok"
  address: "กรุงเทพมหานคร — ประกาศ venue final ก่อน 1 สัปดาห์"
  virtual: false
outcomes:
...
syllabus:
  - title: "Day 1 — ทำความเข้าใจลูกค้า (Understanding the Buyer)"
    body: "4 Personality Types ของลูกค้า B2B · Sales Process 6 ขั้นแบบ consultative · SPIN Selling framework · role-play ด้วย scenarios จริง"
    duration: "6 ชั่วโมง"
  - title: "Day 2 — ปิดดีลโดยไม่กดราคา (Value Closing)"
    body: "Value Centric Selling — แปลงสเปคสินค้าเป็นคุณค่าที่ลูกค้าเข้าใจ · Objection Handling 8 แบบที่เจอบ่อยในตลาดไทย · B2B Negotiation · Closing Psychology"
    duration: "6 ชั่วโมง"
  - title: "Bonus — AI Role-play Bot access"
...
faq:
  - q: "ทำไมต้องแยก 2 วัน ทำ 1 วันได้ไหม?"
