...
- [AI Agent ต่างจาก chatbot ยังไง](/faq) — ตัวอย่างจริงจาก client + stack ที่แนะนำ
- [AI workshop SME ไทยต้องเตรียมอะไรบ้าง](/faq) — 4 สิ่งที่ต้องเตรียมก่อนวัน workshop
- [ไม่เก่ง tech เริ่มใช้ AI ได้ไหม](/faq) — เคส Forklift 5 คนใช้ AI ลด report 2 ชม. → 15 นาที
- [KPI dashboard บน Google Sheets](/faq) — ทำไมไม่ต้องซื้อ Power BI / Tableau

## เริ่มต้นที่ปุ่มเดียว

- [กรอกแบบประเมิน 3 นาที](/intake-form) — ผมอ่านเองและตอบกลับใน 2 วันทำการ
- [AI Day Workshop ฿30,000](/services/ai-workshop) — เห็นวิธีทำงานจริง 1 วัน
