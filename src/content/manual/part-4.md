...
- Public class · 25 ที่ · Waiting List ปิด 31 พ.ค. · application-based · Early Bird Lock ฿12,900 (ราคาเปิดจริง ฿16,900)

> คลาสเล็ก เน้นลงมือ ห้องเรียนที่คุยเปิด ทุกคนได้แชร์ use case จริง นี่คือสิ่งที่ open class ใหญ่ๆ 100 คนทำไม่ได้ ติดตรงไหนมาปรึกษากันในห้องเลย ผมช่วยดูให้ คลาสนี้เราจะไปพร้อมกัน
