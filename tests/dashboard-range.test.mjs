...
const selected = [
  lead({ full_name: 'Won', deal_outcome: 'won', pipeline_status: 'Proposal Sent', package_price: 1, tax_mode: 'cash', business_type: 'Retail', last_touch_at: '2026-08-10T04:00:00.000Z' }),
...
const purchases = [
  { purchased_at: '2026-08-10T04:00:00.000Z', net_amount_thb: 9700 },
  { purchased_at: '2026-07-10T04:00:00.000Z', net_amount_thb: 5000 },
];
const dashboard = buildRangeDashboard(
  selected,
  purchases,
  new Date('2026-08-10T12:00:00+07:00'),
  new Date('2026-08-10T00:00:00+07:00'),
  new Date('2026-08-11T00:00:00+07:00'),
);
...
check(dashboard.kpis.sales_total === 9700, 'sales comes from in-range recorded payments, not the lead quote value');
